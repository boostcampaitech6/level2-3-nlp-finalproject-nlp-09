...
def main():
  ...
  if st.session_state['today_data'].empty:
    ...
    st.write(f'오늘은 {st.session_state.id}님의 감정은 {emotion_title[0]} {emotion_value[0] * 100:.0f}%, {emotion_title[1]} {emotion_value[1] * 100:.0f}%, {emotion_title[1]} {emotion_value[1] * 100:.0f}%입니다.')
