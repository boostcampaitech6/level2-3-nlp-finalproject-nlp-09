...
model = AutoModelForSequenceClassification.from_pretrained("bunoheb/emotion_classifier_detail")
model.to(device)
# Tokenizer
...
with open(r'/home/kgy/level2-3-nlp-finalproject-nlp-09/modeling/num_to_detail.pkl','rb') as f:
...
async def predict(request: PredictionRequest) -> PredictionResponse:
    ...
    prob = [float(f"{number:.2f}") for number in prob[0]]
